...
/*
 ...
 Your task is to write the JavaScript function that:

 filters out the Objects (all primitive data type objects and arrays are filtered) and returns a new array with the extracted elements.
...
function extractObjects(array) {
    ...
    array.forEach(function(arrElement) {
        if (arrElement.constructor === Object) {
            extractedElements.push(arrElement);
        }
    });
